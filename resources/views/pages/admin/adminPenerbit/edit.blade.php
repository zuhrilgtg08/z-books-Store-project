@extends('dashboard.layouts.admin', ['title' => 'Edit Penerbit', 'sbMaster' => true, 'sbActive' => 'data.penerbit'])
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-lg my-5">
                <div class="card-header">
                    <h1 class="h2 text-gray-800 text-center">Edit Penerbit</h1>
                </div>
                <div class="card-body">
                    <form action="{{ route('penerbit.update', $penerbit->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_penerbit') is-invalid @enderror"
                                id="nama-penerbit" name="nama_penerbit" required
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                name="slug" value="{{ old('slug', $penerbit->slug) }}">
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tahun_terbit') is-invalid @enderror"
                                id="tahun-terbit" name="tahun_terbit" required
                                value="{{ old('tahun_terbit', $penerbit->tahun_terbit) }}">
                            @error('tahun_terbit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
